...
const StaffDetailScreen = ({route}) => {
    ...
    const overalRank = listRankingsOverall.map((o) => o.name).indexOf(staff.fields.name);
    const attendanceRank = listRankingsAttendance.map((o) => o.name).indexOf(staff.fields.name);
    const salesRank = listRankingsSales.map((o) => o.name).indexOf(staff.fields.name);
    const knowledgeRank = listRankingsKnowledge.map((o) => o.name).indexOf(staff.fields.name);
    const teamworkRank = listRankingsTeamwork.map((o) => o.name).indexOf(staff.fields.name);
    const toolsRank = listRankingsTools.map((o) => o.name).indexOf(staff.fields.name);
        ...
        <Card>
            ...
            <Card.Content style={{marginTop: 20, flexDirection:'row', flexWrap: 'wrap'}}>    
                <Card.Content>    
                    ...
                    <Paragraph>{attendanceRank +1}{attendanceRankEnding}</Paragraph>
                </Card.Content>
                <Card.Content>    
                    <Title>Knowledge</Title>
                    <Paragraph>{knowledgeRank+1}{knowledgeRankEnding}</Paragraph>
                </Card.Content>
                <Card.Content>    
                    <Title>Team Work</Title>
                    <Paragraph>{teamworkRank+1}{teamworkRankEnding}</Paragraph>
                </Card.Content>
                <Card.Content>    
                    <Title>Tools</Title>
                    <Paragraph>{toolsRank+1}{toolsRankEnding}</Paragraph>
                </Card.Content>
                <Card.Content>    
                    <Title>Sales</Title>
                    <Paragraph>{salesRank+1}{salesRankEnding}</Paragraph>
                </Card.Content>
                {/* <Card.Actions>
